var monster = function(game) {
	...
	this.initMonster = function() {
		...
		**/
		let pmonster1 = new monsterPosition(0, 100, 0, 100, 240, 340, true); 
		let pmonster2 = new monsterPosition(0, 315, 0, 315, 240, 315, true); 
		let pmonster3 = new monsterPosition(0, 530, 0, 530, 240, 290, true); 
		let pmonster4 = new monsterPosition(215, 530, 215, 530, 215, 290, true); 
		let pmonster5 = new monsterPosition(430, 530, 430, 530, 190, 290, true); 
		let pmonster6 = new monsterPosition(430, 315, 430, 315, 190, 315, true); 
		let pmonster7 = new monsterPosition(430, 100, 430, 100, 190, 340, true); 
		let pmonster8 = new monsterPosition(215, 100, 215, 100, 215, 340, true);
		...
		this.pos = postions[this.getRandom(0, 7)];
	}
